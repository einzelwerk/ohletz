...
var servicesCards = document.querySelectorAll(".js-services-cards");
var callback = function callback(entries) {
  entries.forEach(function (entry) {
    var elem = entry;
    if (elem.isIntersecting) {
      var target = elem.target;
      document.querySelectorAll('.services-nav__item').forEach(function (el) {
        el.classList.remove('services-nav__item--current');
      });
      document.querySelector(".services-nav__item[data-id=\"".concat(target.id, "\"]")).classList.add("services-nav__item--current");
    }
  });
};
var options = {
...
var presentationButtons = document.querySelectorAll('.js-show-more');
if (presentationButtons) {
  presentationButtons.forEach(function (el) {
...
/*!
  ...
  */
(function (global, factory) {
   true ? module.exports = factory(__webpack_require__(72), __webpack_require__(286), __webpack_require__(737), __webpack_require__(695)) :
  0;
...
;// CONCATENATED MODULE: ./src/scripts/utils/MatchMedia.js
var MatchMedia_breakpoints = {
  isMobile: "(max-width:768px)",
  isDesktop: "(min-width:769px)"
};
/* harmony default export */ const MatchMedia = (MatchMedia_breakpoints);
;// CONCATENATED MODULE: ./src/scripts/Classes/Sliders.js
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var Sliders = /*#__PURE__*/function () {
  ...
  _createClass(Sliders, null, [{
    ...
    value: function benifitsSlider() {
      ...
      if (root) {
        root.forEach(function (elem) {
          var sliderInstance = new core(elem, {
            modules: [Mousewheel],
            init: false,
            slidesPerView: 1.1,
            spaceBetween: 12,
          ...
          if (window.matchMedia(MatchMedia.isMobile).matches) {
            sliderInstance.init();
          }
        });
      }
    ...
    key: "fullwidthSlider",
    value: function fullwidthSlider() {
      var root = document.querySelector('.js-full-w-slider');
      if (root) {
        var sliderInstance = new core(root, {
          modules: [Mousewheel, Pagination, Navigation],
          init: false,
    ...
    key: "facts",
    value: function facts() {
      var sliderInstance = new core('.js-facts-slider', {
...
ScrollSmoother_isViewport = function _isViewport(e) {
  return !!~ScrollSmoother_root.indexOf(e);
},
    ScrollSmoother_getTime = Date.now,
  ...
  function ScrollSmoother(vars) {
    ...
    var _vars = vars,
      ...
      if (!ScrollSmoother_ScrollTrigger.isRefreshing) {
        var max = ScrollSmoother_ScrollTrigger.maxScroll(wrapper);
      ...
      if (effects) {
        ...
        effects.forEach(function (st) {
          var start = st.start,
              end = st.auto ? Math.min(ScrollSmoother_ScrollTrigger.maxScroll(st.scroller), st.end) : start + (st.end - start) / st.ratio,
    ...
    this.scrollTo = function (target, smooth, position) {
      var p = ScrollSmoother_gsap.utils.clamp(0, ScrollSmoother_ScrollTrigger.maxScroll(ScrollSmoother_win), isNaN(target) ? _this.offset(target, position) : +target);
    ...
    mainST = ScrollSmoother_ScrollTrigger.create({
      ...
      onRefreshInit: function onRefreshInit(self) {
        ...
        if (effects) {
          var pins = ScrollSmoother_ScrollTrigger.getAll().filter(function (st) {
            return !!st.pin;
          });
          effects.forEach(function (st) {
      ...
      onRefresh: function onRefresh(self) {
        ...
        render(scroll.y);
        startupPhase || self.animation.progress(ScrollSmoother_gsap.utils.clamp(0, 1, recordedRefreshScroll / speed / -self.end));
...
var SplitText = /*#__PURE__*/function () {
  function SplitText(element, vars) {
    ...
    SplitText_bonusValidated && this.split(vars);
  }
...
var archonLinks = document.querySelectorAll('a[href^="#"]');
archonLinks.forEach(function (t) {
